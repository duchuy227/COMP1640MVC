                ...
                <table class="table table-bordered border-bold">
                    ...
                    <tbody>
                        ...
                        <tr class="table bordered" style=" background-color: #A095C4; text-align:center">
                            <td scope="row"><?php echo $maga['Stu_FullName'] ?></td>
                            <td scope="row"><?php echo $maga['Con_Name'] ?></td>
                            <td scope="row"><?php echo $maga['Maga_CreateTime'] ?></td>
                            <td scope="row"><?php echo $maga['Topic_Name'] ?></td>
                            <td scope="row"><?php echo $maga['Fa_Name'] ?></td>
                            <td scope="row"><?php echo $maga['Maga_Status'] ?></td>
                            <td>
                                <button class="btn btn-secondary">
                                    <a style="text-decoration: none; color:#fff"
                                    href="index.php?action=admin_magazine_detail&id=<?php echo $maga['Maga_ID'] ?>"><i class="bi bi-files"></i></a>
                                </button>
                            </td>                                
                        </tr>
                        <?php endforeach; ?>
