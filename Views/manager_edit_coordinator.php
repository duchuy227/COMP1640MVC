		...
		<main>
			<div class="data">
                <div class="content-data">
                    <h2 style="color: #009966; text-align:center; text-transform:uppercase;">Edit Coordinator</h2>
                    <br>
                    <form  method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="password" name="password" value="<?php echo $admin['Coor_Password']; ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            ?>
                            <br>
                            <input type="hidden" name="avatar" id="avatar" value="<?= base64_encode($admin['Image'])?>">                        </div>
