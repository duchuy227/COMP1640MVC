    ...
    <div class="main--content">
        ...
        <form action="index.php?action=update_manager&id=<?php echo $admin['Ma_ID']; ?>" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="username" name="username" value="<?php echo $admin['Ma_Username']; ?>">
                <?php 
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" name="password" value="<?php echo $admin['Ma_Password']; ?>">
                <?php 
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" value="<?php echo $admin['Ma_Email']; ?>" >
                <?php 
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="dob" name="dob" value="<?php echo $admin['Ma_DOB']; ?>" >
