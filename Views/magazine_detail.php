    ...
    <section id="blog-container">
        <div class="blogs blogpost">
            <div class="post">
                ...
                <h6>Author: <?php echo $maga['Stu_FullName'] ?></h6>
                <h6>Create Time: <?php echo $maga['Maga_CreateTime'] ?></h6>
                <h6>Topic: <?php echo $maga['Topic_Name'] ?></h6>
                <h6>Faculty: <?php echo $maga['Fa_Name'] ?></h6>
                <br>
                <p><?php echo $html ?></p>
                <a href="index.php?action=magazine">Back to Magazine</a>
            </div>
        </div>
    </section>
