    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
				<div class="left">
					<h3 style="color: #FF6347;">Profile</h3>
				</div>
			</div>
            <div class="table-data">
				<div class="order">
                    <h4 style="color: #009879; text-align:center; text-transform:uppercase;">My Profile</h4>
                    <div class="row no-gutters">
                            <div class="col-md-5">
                                <img class="img-small" width="370" src="<?php echo ($coorInfo['Image'] != null) ? 'data:image/*;base64,' . base64_encode($coorInfo['Image']) : 'placeholder_image_url.jpg'; ?>" class="img-fluid">
                                <img class="img-fullscreen" src="<?php echo ($coorInfo['Image'] != null) ? 'data:image/*;base64,' . base64_encode($coorInfo['Image']) : 'placeholder_image_url.jpg'; ?>" class="img-fluid">
                            </div>
                            <div class="col-md-7">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <p style="color: #303030; font-size: 20px;"><?php echo $coorInfo['Coor_Username'] ; ?></p>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-sm-4">
                                        ...
                                        <p style="color: #303030; font-size: 20px;"><?php echo $coorInfo['Coor_Email'] ; ?></p>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-sm-4">
                                        ...
                                        <p style="color: #303030; font-size: 20px;"><?php echo $coorInfo['Coor_FullName'] ; ?></p>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-sm-4">
                                        ...
                                        <p style="color: #303030; font-size: 20px;"><?php echo $coorInfo['Coor_DOB'] ; ?></p>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-sm-4">
                                        ...
                                        <p style="color: #303030; font-size: 20px;"><?php echo $coorInfo['Fa_Name'] ; ?></p>
                                    </div>
                                    <br>
